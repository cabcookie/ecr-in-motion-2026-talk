  ...
  },
  {
    ...
    panels: [
      ...
      },
      {
        ...
        mock: {
          t: "qr",
          caption: "Du bist jetzt Lieferant.",
          hint: "Lies Dein Briefing. Dann öffnet der Link Dein Mailprogramm — der Entwurf steht schon.",
        },
    ...
    panels: [
      {
        ...
        mock: {
          ...
          caption:
            "Vereinfacht — aber so sieht Wissensarbeit aus: breit genug, um mit anderen Disziplinen zu reden, tief genug, um die eigene Aufgabe zu lösen.",
        },
    ...
    panels: [
      ...
      },
      {
        ...
        mock: {
          ...
          caption:
            "Memory ist der Teil, der nicht von Dir geschrieben wird, sondern entsteht.",
        },
